package com.github.walkvoid.zone.ai.channel.config;

import com.github.walkvoid.zone.ai.channel.core.AbstractChannelBotLifecycle;
import com.github.walkvoid.zone.ai.channel.core.ChannelBotClient;
...
import com.github.walkvoid.zone.ai.channel.support.EchoChannelMessageHandler;
 ...
 * 通道模块装配。
 * <p>
 * 各厂商 {@link AbstractChannelBotLifecycle}
