$(function () {
	...
	Highcharts.chart('chart5', {
		...
		subtitle: {
			text: 'Source: <a href="#">statcounter.com</a>'
		},
		plotOptions: {
			pie: {
				shadow: false,
	...
	Highcharts.chart('chart11', {
		...
		subtitle: {
			text: 'Sources: <a href="#">' + 'thebulletin.org</a> &amp; <a href="#">' + 'armscontrol.org</a>'
		},
		xAxis: {
			allowDecimals: false,
			labels: {
	...
	Highcharts.chart('chart13', {
		...
		series: [{
			...
			type: 'column',
			yAxis: 1,
			data: [49.9, 71.5, 106.4, 129.2, 143.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
			tooltip: {
				valueSuffix: ' mm'
			}
		}, {
			name: 'Temperature',
			type: 'spline',
			data: [7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 22.2, 26.5, 23.3, 18.3, 13.9, 9.6],
			tooltip: {
				valueSuffix: '°C'
			}
		}]
	...
	Highcharts.chart('chart14', {
		...
		xAxis: {
			categories: ['Pears', 'Apples', 'Oranges', 'Grapes', 'Bananas']
		},
		credits: {
			enabled: false
		},
	...
	Highcharts.chart('chart15', {
		...
		xAxis: {
			categories: ['Oranges', 'Apples', 'Pears', 'Grapes', 'Bananas']
		},
		yAxis: {
			min: 0,
			title: {
